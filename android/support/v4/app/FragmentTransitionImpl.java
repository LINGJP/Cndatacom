  ...
  void setNameOverridesReordered(View paramView, final ArrayList<View> sharedElementsOut, final ArrayList<View> sharedElementsIn, final ArrayList<String> inNames, Map<String, String> paramMap) {
    ...
    for (i = 0; i < j; i++) {
      ...
      if (str != null) {
        ...
        int k;
        for (k = 0; k < j; k++) {
          if (str1.equals(inNames.get(k))) {
            ViewCompat.setTransitionName(sharedElementsIn.get(k), str);
            break;
          } 
        } 
      } 
...
/* Location:              C:\Users\15856\Desktop\2675384-dex2jar.jar!\android\support\v4\app\FragmentTransitionImpl.class
