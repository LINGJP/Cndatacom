...
final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManagerImpl.OpGenerator {
  ...
  private void doAddOp(int paramInt1, Fragment paramFragment, @Nullable String paramString, int paramInt2) {
    ...
    ((Fragment)stringBuilder).mFragmentManager = this.mManager;
    if (paramString != null) {
      if (((Fragment)stringBuilder).mTag != null && !paramString.equals(((Fragment)stringBuilder).mTag)) {
        StringBuilder stringBuilder1 = new StringBuilder();
        stringBuilder1.append("Can't change tag of fragment ");
        stringBuilder1.append(stringBuilder);
        stringBuilder1.append(": was ");
        stringBuilder1.append(((Fragment)stringBuilder).mTag);
        stringBuilder1.append(" now ");
        stringBuilder1.append(paramString);
        throw new IllegalStateException(stringBuilder1.toString());
      } 
      ((Fragment)stringBuilder).mTag = paramString;
    } 
    if (paramInt1 != 0) {
      if (paramInt1 == -1) {
        StringBuilder stringBuilder1 = new StringBuilder();
      ...
      if (((Fragment)stringBuilder).mFragmentId != 0 && ((Fragment)stringBuilder).mFragmentId != paramInt1) {
        StringBuilder stringBuilder1 = new StringBuilder();
        stringBuilder1.append("Can't change container ID of fragment ");
        stringBuilder1.append(stringBuilder);
        stringBuilder1.append(": was ");
        stringBuilder1.append(((Fragment)stringBuilder).mFragmentId);
        stringBuilder1.append(" now ");
        stringBuilder1.append(paramInt1);
        throw new IllegalStateException(stringBuilder1.toString());
      } 
      ((Fragment)stringBuilder).mFragmentId = paramInt1;
      ((Fragment)stringBuilder).mContainerId = paramInt1;
    } 
    addOp(new Op(paramInt2, (Fragment)stringBuilder));
  }
...
/* Location:              C:\Users\15856\Desktop\2675384-dex2jar.jar!\android\support\v4\app\BackStackRecord.class
