...
public class Fragment implements e, q, ComponentCallbacks, View.OnCreateContextMenuListener {
  ...
  public LiveData<e> getViewLifecycleOwnerLiveData() {
    return (LiveData<e>)this.mViewLifecycleOwnerLiveData;
  }
  ...
  void performCreateView(@NonNull LayoutInflater paramLayoutInflater, @Nullable ViewGroup paramViewGroup, @Nullable Bundle paramBundle) {
    ...
    this.mViewLifecycleOwner = new e() {
        public c getLifecycle() {
          ...
          return (c)Fragment.this.mViewLifecycleRegistry;
        }
      };
  ...
  public final void requestPermissions(@NonNull String[] paramArrayOfString, int paramInt) {
    ...
    this.mHost.onRequestPermissionsFromFragment(this, (String[])stringBuilder, paramInt);
  }
  ...
  public final FragmentActivity requireActivity() {
    ...
    return (FragmentActivity)stringBuilder;
  }
  ...
  public final FragmentManager requireFragmentManager() {
    ...
    return (FragmentManager)stringBuilder;
  }
  ...
  void setOnStartEnterTransitionListener(OnStartEnterTransitionListener paramOnStartEnterTransitionListener) {
    ...
    if (this.mAnimationInfo.mEnterTransitionPostponed)
      this.mAnimationInfo.mStartEnterTransitionListener = (OnStartEnterTransitionListener)stringBuilder; 
  ...
  public void setTargetFragment(@Nullable Fragment paramFragment, int paramInt) {
    ...
    while (fragment != null) {
      ...
      Fragment fragment1 = stringBuilder.getTargetFragment();
    } 
  ...
  public void startActivity(Intent paramIntent, @Nullable Bundle paramBundle) {
    ...
    this.mHost.onStartActivityFromFragment(this, (Intent)stringBuilder, -1, paramBundle);
  }
  ...
  public void startActivityForResult(Intent paramIntent, int paramInt, @Nullable Bundle paramBundle) {
    ...
    this.mHost.onStartActivityFromFragment(this, (Intent)stringBuilder, paramInt, paramBundle);
  }
  ...
  public void startIntentSenderForResult(IntentSender paramIntentSender, int paramInt1, @Nullable Intent paramIntent, int paramInt2, int paramInt3, int paramInt4, Bundle paramBundle) {
    ...
    this.mHost.onStartIntentSenderFromFragment(this, (IntentSender)stringBuilder, paramInt1, paramIntent, paramInt2, paramInt3, paramInt4, paramBundle);
  }
...
/* Location:              C:\Users\15856\Desktop\2675384-dex2jar.jar!\android\support\v4\app\Fragment.class
