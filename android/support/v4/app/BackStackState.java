...
final class BackStackState implements Parcelable {
  ...
  public BackStackRecord instantiate(FragmentManagerImpl paramFragmentManagerImpl) {
    ...
    while (j < this.mOps.length) {
      ...
      k = arrayOfInt[k];
      if (k >= 0) {
        op.fragment = (Fragment)paramFragmentManagerImpl.mActive.get(k);
      } else {
        op.fragment = null;
      } 
      arrayOfInt = this.mOps;
...
/* Location:              C:\Users\15856\Desktop\2675384-dex2jar.jar!\android\support\v4\app\BackStackState.class
