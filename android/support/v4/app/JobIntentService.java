...
public abstract class JobIntentService extends Service {
  ...
  static WorkEnqueuer getWorkEnqueuer(Context paramContext, ComponentName paramComponentName, boolean paramBoolean, int paramInt) {
    WorkEnqueuer workEnqueuer2 = sClassWorkEnqueuer.get(paramComponentName);
  ...
  public int onStartCommand(@Nullable Intent paramIntent, int paramInt1, int paramInt2) {
    if (this.mCompatQueue != null) {
      ...
      synchronized (this.mCompatQueue) {
        ...
        arrayList.add(new CompatWorkItem(paramIntent, paramInt2));
...
/* Location:              C:\Users\15856\Desktop\2675384-dex2jar.jar!\android\support\v4\app\JobIntentService.class
