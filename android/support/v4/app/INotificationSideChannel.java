  ...
  public static abstract class Stub extends Binder implements INotificationSideChannel {
    ...
    public boolean onTransact(int param1Int1, Parcel param1Parcel1, Parcel param1Parcel2, int param1Int2) {
      ...
      if (param1Int1 != 1598968902) {
        ...
        notify(str, param1Int1, str1, (Notification)param1Parcel1);
        return true;
      } 
    ...
    private static class Proxy implements INotificationSideChannel {
      ...
      public void cancel(String param2String1, int param2Int, String param2String2) {
      ...
      public void cancelAll(String param2String) {
        Parcel parcel = Parcel.obtain();
        try {
          parcel.writeInterfaceToken("android.support.v4.app.INotificationSideChannel");
      ...
      public void notify(String param2String1, int param2Int, String param2String2, Notification param2Notification) {
        Parcel parcel = Parcel.obtain();
        try {
          parcel.writeInterfaceToken("android.support.v4.app.INotificationSideChannel");
          parcel.writeString(param2String1);
...
/* Location:              C:\Users\15856\Desktop\2675384-dex2jar.jar!\android\support\v4\app\INotificationSideChannel.class
