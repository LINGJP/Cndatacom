...
public class FragmentActivity extends SupportActivity implements q, ActivityCompat.OnRequestPermissionsResultCallback, ActivityCompat.RequestPermissionsRequestCodeValidator {
  ...
  private static boolean markState(FragmentManager paramFragmentManager, c.b paramb) {
    ...
    while (iterator.hasNext()) {
      ...
      if (fragment == null)
        continue; 
      boolean bool1 = bool;
      if (fragment.getLifecycle().a().a(c.b.d)) {
        fragment.mLifecycleRegistry.a(paramb);
        bool1 = true;
      } 
      FragmentManager fragmentManager = fragment.peekChildFragmentManager();
      bool = bool1;
      if (fragmentManager != null)
        bool = bool1 | markState(fragmentManager, paramb); 
    } 
    return bool;
  }
  ...
  public void dump(String paramString, FileDescriptor paramFileDescriptor, PrintWriter paramPrintWriter, String[] paramArrayOfString) {
    ...
    if (getApplication() != null)
      LoaderManager.<FragmentActivity>getInstance(this).dump(str, paramFileDescriptor, paramPrintWriter, paramArrayOfString); 
...
/* Location:              C:\Users\15856\Desktop\2675384-dex2jar.jar!\android\support\v4\app\FragmentActivity.class
