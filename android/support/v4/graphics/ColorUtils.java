...
public final class ColorUtils {
  ...
  public static Color compositeColors(@NonNull Color paramColor1, @NonNull Color paramColor2) {
    ...
    arrayOfFloat2[j] = f4 + f3;
    float f2 = f3;
    float f1 = f4;
    if (arrayOfFloat2[j] > 0.0F) {
      f1 = f4 / arrayOfFloat2[j];
      f2 = f3 / arrayOfFloat2[j];
    } 
    int i;
    for (i = 0; i < j; i++)
      arrayOfFloat2[i] = arrayOfFloat1[i] * f1 + arrayOfFloat2[i] * f2; 
  ...
  private static double pivotXyzComponent(double paramDouble) {
    return (paramDouble > 0.008856D) ? Math.pow(paramDouble, 0.3333333333333333D) : ((paramDouble * 903.3D + 16.0D) / 116.0D);
  }
...
/* Location:              C:\Users\15856\Desktop\2675384-dex2jar.jar!\android\support\v4\graphics\ColorUtils.class
