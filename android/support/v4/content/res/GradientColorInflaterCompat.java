...
final class GradientColorInflaterCompat {
  ...
  static Shader createFromXmlInner(@NonNull Resources paramResources, @NonNull XmlPullParser paramXmlPullParser, @NonNull AttributeSet paramAttributeSet, @Nullable Resources.Theme paramTheme) {
    ...
    TypedArray typedArray = TypedArrayUtils.obtainAttributes((Resources)stringBuilder, paramTheme, paramAttributeSet, R.styleable.GradientColor);
    ...
    typedArray.recycle();
    ColorStops colorStops = checkColors(inflateChildElements((Resources)stringBuilder, paramXmlPullParser, paramAttributeSet, paramTheme), j, m, bool, k);
    switch (i) {
      default:
...
/* Location:              C:\Users\15856\Desktop\2675384-dex2jar.jar!\android\support\v4\content\res\GradientColorInflaterCompat.class
