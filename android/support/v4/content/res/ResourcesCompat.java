    ...
    try {
      if (str.toLowerCase().endsWith(".xml")) {
        ...
        if (familyResourceEntry == null) {
          ...
          return TypefaceCompat.createFromResourcesFamilyXml((Context)stringBuilder, familyResourceEntry, paramResources, paramInt1, paramInt2, paramFontCallback, paramHandler, paramBoolean);
        } 
      } else {
        Typeface typeface1 = TypefaceCompat.createFromResourcesFontFile((Context)stringBuilder, paramResources, paramInt1, str, paramInt2);
        if (paramFontCallback != null) {
          if (typeface1 != null) {
...
/* Location:              C:\Users\15856\Desktop\2675384-dex2jar.jar!\android\support\v4\content\res\ResourcesCompat.class
