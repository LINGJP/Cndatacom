...
public class ViewDragHelper {
  ...
  public void captureChildView(@NonNull View paramView, int paramInt) {
    ...
    this.mCapturedView = (View)stringBuilder;
    this.mActivePointerId = paramInt;
    this.mCallback.onViewCaptured((View)stringBuilder, paramInt);
    setDragState(1);
  }
          ...
          while (true) {
            if (i < k) {
              ...
              if (m != this.mActivePointerId) {
                ...
                if (findTopChildUnder((int)f3, (int)f4) == this.mCapturedView && tryCaptureViewForDrag(this.mCapturedView, m)) {
      ...
      case 2:
        ...
        for (i = j; i < k; i++) {
          ...
          if (isValidPointerForActionMove(j)) {
            ...
            if (checkTouchSlop(view1, f3, f4) && tryCaptureViewForDrag(view1, j))
              break; 
          } 
        } 
        saveLastMotion(paramMotionEvent);
        ...
        for (i = 0; i < k; i++) {
          ...
          if (isValidPointerForActionMove(m)) {
            ...
            if (j != 0) {
              ...
              int i2 = view1.getTop();
              int i3 = (int)f4;
              i3 = this.mCallback.clampViewPositionVertical(view1, i2 + i3, i3);
...
/* Location:              C:\Users\15856\Desktop\2675384-dex2jar.jar!\android\support\v4\widget\ViewDragHelper.class
