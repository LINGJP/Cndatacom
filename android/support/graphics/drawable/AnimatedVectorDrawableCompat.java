        ...
        if ("animated-vector".equals(str)) {
          ...
          if (i != 0)
            if (this.mContext != null) {
              setupAnimatorsForTarget(str1, AnimatorInflaterCompat.loadAnimator(this.mContext, i));
            } else {
              typedArray.recycle();
    ...
    if (this.mAnimatorListener == null)
      this.mAnimatorListener = (Animator.AnimatorListener)new AnimatorListenerAdapter() {
          public void onAnimationEnd(Animator param1Animator) {
            ArrayList<Animatable2Compat.AnimationCallback> arrayList = new ArrayList<Animatable2Compat.AnimationCallback>(AnimatedVectorDrawableCompat.this.mAnimationCallbacks);
    ...
    public AnimatedVectorDrawableCompatState(Context param1Context, AnimatedVectorDrawableCompatState param1AnimatedVectorDrawableCompatState, Drawable.Callback param1Callback, Resources param1Resources) {
      if (param1AnimatedVectorDrawableCompatState != null) {
        ...
        if (param1AnimatedVectorDrawableCompatState.mAnimators != null) {
          int j = param1AnimatedVectorDrawableCompatState.mAnimators.size();
          this.mAnimators = new ArrayList<Animator>(j);
          this.mTargetNameMap = new ArrayMap(j);
          while (i < j) {
            Animator animator2 = param1AnimatedVectorDrawableCompatState.mAnimators.get(i);
...
/* Location:              C:\Users\15856\Desktop\2675384-dex2jar.jar!\android\support\graphics\drawable\AnimatedVectorDrawableCompat.class
