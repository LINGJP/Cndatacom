...
class AppCompatTextHelper {
  ...
  void loadFromAttributes(AttributeSet paramAttributeSet, int paramInt) {
    ...
    if (i != -1) {
      ...
      if (!bool3 && tintTypedArray3.hasValue(R.styleable.TextAppearance_textAllCaps)) {
      ...
      if (Build.VERSION.SDK_INT < 23) {
        ...
        if (tintTypedArray3.hasValue(R.styleable.TextAppearance_android_textColorLink))
          colorStateList2 = tintTypedArray3.getColorStateList(R.styleable.TextAppearance_android_textColorLink); 
      } else {
    ...
    if (Build.VERSION.SDK_INT < 23) {
      ...
      if (tintTypedArray5.hasValue(R.styleable.TextAppearance_android_textColor))
        colorStateList = tintTypedArray5.getColorStateList(R.styleable.TextAppearance_android_textColor); 
      if (tintTypedArray5.hasValue(R.styleable.TextAppearance_android_textColorHint))
        colorStateList1 = tintTypedArray5.getColorStateList(R.styleable.TextAppearance_android_textColorHint); 
...
/* Location:              C:\Users\15856\Desktop\2675384-dex2jar.jar!\android\support\v7\widget\AppCompatTextHelper.class
