...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    try {
      ...
      try {
        ...
        try {
          ...
          stringBuilder.append(paramUri);
          Log.e("SuggestionsAdapter", stringBuilder.toString(), iOException1);
        } 
      } 
  ...
  Drawable getDrawableFromResourceUri(Uri paramUri) {
    ...
    try {
      ...
      Resources resources = this.mContext.getPackageManager().getResourcesForApplication((String)stringBuilder);
      ...
      if (i == 1)
        try {
          ...
          stringBuilder1.append("Single path segment is not a resource ID: ");
          stringBuilder1.append(paramUri);
          throw new FileNotFoundException(stringBuilder1.toString());
        }  
      if (i == 2) {
        i = resources.getIdentifier(list.get(1), list.get(0), (String)stringBuilder1);
      } else {
        stringBuilder1 = new StringBuilder();
        stringBuilder1.append("More than two path segments: ");
        stringBuilder1.append(paramUri);
        throw new FileNotFoundException(stringBuilder1.toString());
      } 
      if (i == 0) {
...
/* Location:              C:\Users\15856\Desktop\2675384-dex2jar.jar!\android\support\v7\widget\SuggestionsAdapter.class
