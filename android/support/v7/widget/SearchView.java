...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
  ...
  private Intent createIntentFromSuggestion(Cursor paramCursor, int paramInt, String paramString) {
    ...
    if (str3 == null) {
      ...
      return createIntent(str2, (Uri)str1, SuggestionsAdapter.getColumnString((Cursor)stringBuilder, "suggest_intent_extra_data"), str3, paramInt, (String)runtimeException);
    } 
    Uri uri = Uri.parse(str3);
    str3 = SuggestionsAdapter.getColumnString((Cursor)stringBuilder, "suggest_intent_query");
    return createIntent(str2, uri, SuggestionsAdapter.getColumnString((Cursor)stringBuilder, "suggest_intent_extra_data"), str3, paramInt, (String)runtimeException);
  }
    ...
    public boolean onTouchEvent(MotionEvent param1MotionEvent) {
      ...
      if (bool1) {
        if (i != 0 && !this.mActualBounds.contains(j, k)) {
          ...
          param1MotionEvent.setLocation((j - this.mActualBounds.left), (k - this.mActualBounds.top));
        } 
...
/* Location:              C:\Users\15856\Desktop\2675384-dex2jar.jar!\android\support\v7\widget\SearchView.class
