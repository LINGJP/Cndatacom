...
public class AnimatedStateListDrawableCompat extends StateListDrawable {
  ...
  static class AnimatedStateListState extends StateListDrawable.StateListState {
    ...
    int addTransition(int param1Int1, int param1Int2, @NonNull Drawable param1Drawable, boolean param1Boolean) {
      ...
      if (param1Boolean) {
        ...
        this.mTransitions.append(l2, Long.valueOf(l3 | 0x100000000L | l1));
      } 
      return i;
    }
  ...
  private static class FrameInterpolator implements TimeInterpolator {
    ...
    public float getInterpolation(float param1Float) {
      int j = (int)(param1Float * this.mTotalDuration + 0.5F);
      int k = this.mFrames;
...
/* Location:              C:\Users\15856\Desktop\2675384-dex2jar.jar!\android\support\v7\graphics\drawable\AnimatedStateListDrawableCompat.class
