  ...
  public boolean isValidConnection(ConstraintAnchor paramConstraintAnchor) {
    ...
    switch (this.mType) {
      ...
      case BOTTOM:
        ...
        bool2 = bool1;
        return (paramConstraintAnchor.getOwner() instanceof Guideline) ? ((bool1 || type == Type.CENTER_Y)) : bool2;
      case LEFT:
      case RIGHT:
        ...
        bool2 = bool1;
        return (paramConstraintAnchor.getOwner() instanceof Guideline) ? ((bool1 || type == Type.CENTER_X)) : bool2;
      case CENTER:
        break;
    } 
    boolean bool1 = bool2;
...
/* Location:              C:\Users\15856\Desktop\2675384-dex2jar.jar!\android\support\constraint\solver\widgets\ConstraintAnchor.class
