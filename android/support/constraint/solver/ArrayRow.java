...
public class ArrayRow implements LinearSystem.Row {
  ...
  public void initFromRow(LinearSystem.Row paramRow) {
    if (paramRow instanceof ArrayRow) {
      ...
      this.variable = null;
      this.variables.clear();
      for (int i = 0; i < ((ArrayRow)paramRow).variables.currentSize; i++) {
...
/* Location:              C:\Users\15856\Desktop\2675384-dex2jar.jar!\android\support\constraint\solver\ArrayRow.class
