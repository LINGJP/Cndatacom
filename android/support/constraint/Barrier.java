    ...
    if (paramAttributeSet != null) {
      ...
      for (int i = 0; i < j; i++) {
        ...
        if (k == R.styleable.ConstraintLayout_Layout_barrierDirection) {
          ...
          this.mBarrier.setAllowsGoneWidget(typedArray.getBoolean(k, true));
        } 
      } 
    } 
...
/* Location:              C:\Users\15856\Desktop\2675384-dex2jar.jar!\android\support\constraint\Barrier.class
