...
public class Placeholder extends View {
    ...
    if (paramAttributeSet != null) {
      ...
      for (int i = 0; i < j; i++) {
        ...
        if (k == R.styleable.ConstraintLayout_placeholder_content) {
          this.mContentId = typedArray.getResourceId(k, this.mContentId);
        } else if (k == R.styleable.ConstraintLayout_placeholder_emptyVisibility) {
          this.mEmptyVisibility = typedArray.getInt(k, this.mEmptyVisibility);
        } 
      } 
    } 
  }
  ...
  public void updatePostMeasure(ConstraintLayout paramConstraintLayout) {
    ...
    layoutParams1.widget.setWidth(layoutParams2.widget.getWidth());
    layoutParams1.widget.setHeight(layoutParams2.widget.getHeight());
...
/* Location:              C:\Users\15856\Desktop\2675384-dex2jar.jar!\android\support\constraint\Placeholder.class
