...
public class f extends c {
  ...
  private void b(e parame) {
    Iterator<Map.Entry> iterator = this.a.b();
  ...
  private c.b c(d paramd) {
    ...
    c.b b1 = null;
    if (entry != null) {
      c.b b2 = ((a)entry.getValue()).a;
    } else {
      entry = null;
    } 
    if (!this.g.isEmpty())
      b1 = this.g.get(this.g.size() - 1); 
  ...
  public void a(@NonNull d paramd) {
    ...
    c.b b1 = c(paramd);
    this.d++;
    while (a1.a.compareTo(b1) < 0 && this.a.c(paramd)) {
      c(a1.a);
      a1.a(e, e(a1.a));
      c();
      b1 = c(paramd);
...
/* Location:              C:\Users\15856\Desktop\2675384-dex2jar.jar!\android\arch\lifecycle\f.class
